...
def process_file(file):
    ...
    fasta_directory = "../dataset/prediction/fasta"
    pkl_directory = "../dataset/prediction/pkl"
    esmc_directory = "../dataset/prediction/esmc"  # 新增ESMC目录
    dssp_directory = "../dataset/prediction/dssp"  # 新增DSSP目录
    extra_feat_directory = "../dataset/prediction/extra_feat"
