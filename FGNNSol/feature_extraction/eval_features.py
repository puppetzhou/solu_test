...
def process_file(file):
    ...
    # 设置文件路径
    pdb_directory = "../dataset/eval_data/pdbEval"
    fasta_directory = "../dataset/eval_data/fastaEval"
    pkl_directory = "../dataset/eval_data/pkl"
    esmc_directory = "../dataset/eval_data/esmc"  # 新增ESMC目录
    dssp_directory = "../dataset/eval_data/dssp"  # 新增DSSP目录
    extra_feat_directory = "../dataset/eval_data/extra_feat"
    ...
    try:
        ...
        # 处理未找到的文件（这里指原csv文件未被分到eval中的条目）
        required_files = {
            "PDB": pdb_path,
            "FASTA": fasta_path,
            "ESM": esmc_path,
